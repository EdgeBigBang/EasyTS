...
SubDataset = ['app.csv','app_a.csv','app_b.csv','function.csv']
URL_TEMPLATE = 'http://gitlab.fei8s.com/tianchengZhang/dastaset-for-timeseries/-/raw/main/Cloud/{}.csv'
...
class Dataset_Cloud(Dataset):
    ...
    def download(dataset_path, data_path):
        """
        Download Cloud dataset if doesn't exist.
        """
...
def data_provider_cloud(args, flag):
    """
    Provide Cloud data. list:['app.csv','app_a.csv','app_b.csv','function.csv']
    """
